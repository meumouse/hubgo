...
class License_Activate extends Abstract_Route {
    ...
    public function handle( WP_REST_Request $request ) {
        ...
        if ( '' === $key ) {
            return $this->error_response( __( 'Enter the license key.', 'hubgo' ) );
        }
        ...
        if ( ! $status->is_valid() ) {
            ...
            return $this->error_response(
                '' !== $message ? $message : __( 'Could not activate this license.', 'hubgo' ),
                400,
        ...
        return $this->success_response( array(
            'message' => __( 'License activated successfully!', 'hubgo' ),
            'license' => $payload,
        ) );
    }
}
