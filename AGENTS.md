...
- **Integrations**: Joinotify (WhatsApp automation), Melhor Envio and Frenet, exposed as a card catalog on a dedicated admin screen.
...
app/                        Vue 3 + Vite admin SPA
  src/entries/              One entry per admin page (settings, integrations, license)
