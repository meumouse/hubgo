...
- **Shipping calculator** on the product page: a Vue 3 storefront app (since 3.0.0) with a delivery-date forecast, a free-shipping badge, an address lookup for shoppers who do not know their postcode, and a preferred-method choice that is carried into the checkout.
