 ...
 * preserve sprintf placeholders, HTML markup, HubGo template tokens and brand
 * names, and to detect the source language per string (the POT mixes
...
function buildSystemPrompt(targetLanguage) {
  return [
    "You are a professional software localizer for HubGo, a WooCommerce plugin that manages shipping options, order tracking and the 'shipped' order status.",
    ...
    "- Preserve EXACTLY, without translating or reordering: sprintf placeholders (%s, %d, %1$s, %2$s, %%), HTML tags and their attributes, HTML entities, URLs, email addresses, and template tokens such as {{ hubgo_tracking_code }}, {{ wc_order_total }} and {{ field=[KEY] }}.",
    "- Keep leading and trailing whitespace, line breaks and surrounding punctuation identical to the source.",
    "- Do NOT translate brand/product names: HubGo, WooCommerce, WordPress, WhatsApp, Joinotify, Correios, Melhor Envio, Jadlog, MeuMouse.com.",
